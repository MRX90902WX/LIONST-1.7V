...
def main():
  for i in range(int(cantidad)):                
    ...
    f = open('LIONST1.tx', "a+")
    f.write(f'{cc}xxxx | {dategen()}  | RND\n')
    f.close()
    print(f" \033[1;37m{cc}xxxx \033[1;36m| \033[1;37m{dategen()}  \033[1;36m| \033[1;37mRND \033[1;36m|")
main()

print("")
system("cat post1.txt")
print("")
